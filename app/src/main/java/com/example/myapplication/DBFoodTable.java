...
public class DBFoodTable extends SQLiteOpenHelper implements DBInterface {

    private SQLiteDatabase database;

    private static final String TABLE_RECORD = "FoodList";
    ...
    public DBFoodTable(@Nullable Context context) {
    ...
    public long insert(long userId, Food food) {
        database = getReadableDatabase(); //get access to read database
